...
默认情况下，AkashX 缓存 MaxCompute 的元数据以提高查询性能。因此，在对 MaxCompute 表进行 schema 变更或其他更新后，您可以使用 [REFRESH EXTERNAL TABLE](../../sql-reference/sql-statements/table_bucket_part_index/REFRESH_EXTERNAL_TABLE.md) 手动更新表的元数据，从而确保 AkashX 能够及时获取最新的元数据：
