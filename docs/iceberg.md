...
如果您已经有一个 AkashX 3.2.0 或更高版本的环境，它已包含 Iceberg 1.6.0。无需额外下载或 jar 文件。

#### 了解更多

现在您已经使用 Iceberg 和 AkashX 运行起来了，请查看 [AkashX-Iceberg 文档](../data_source/catalog/iceberg/iceberg_catalog.md) 以了解更多信息！
