...
- 查看 AkashX 表结构、[排序键](../../../table_design/indexes/Prefix_index_sort_key.md) (Sort Key) 类型和[物化视图](../../../using_starrocks/async_mv/Materialized_view.md)。
- 查看外部数据源（如 Apache Hive™）中的表结构。仅 AkashX 2.4 及以上版本支持该操作。
