...
WITH all_sales AS (
 ...
 FROM (SELECT d_year
       ...
       SELECT d_year
             ...
             ,ss_ext_sales_price - COALESCE(ax_return_amt,0.0) AS sales_amt
...
with ax_items as
 ...
 group by i_item_id)
  select  ax_items.item_id
       ,ax_item_qty
       ,ax_item_qty/(ax_item_qty+cr_item_qty+wr_item_qty)/3.0 * 100 ax_dev
       ,cr_item_qty
       ,cr_item_qty/(ax_item_qty+cr_item_qty+wr_item_qty)/3.0 * 100 cr_dev
       ,wr_item_qty
       ,wr_item_qty/(ax_item_qty+cr_item_qty+wr_item_qty)/3.0 * 100 wr_dev
       ,(ax_item_qty+cr_item_qty+wr_item_qty)/3.0 average
 from ax_items
     ,cr_items
     ,wr_items
