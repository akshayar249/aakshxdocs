...
#### 软件包名称示例
1. `AkashX-3.4.0-rc01-ubuntu-amd64.tar.gz`: 为 Ubuntu Linux 构建的 3.4.0 预发布版本。
2. `AkashX-3.4.1-centos-amd64.tar.gz`: 为 Red Hat Enterprise Linux / CentOS 构建的 PATCH 修订版。