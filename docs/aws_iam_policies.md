...
本文介绍在不同场景下选择 [Instance Profile、Assumed Role、及 IAM User 鉴权方式](../integrations/authenticate_to_aws_resources.md#准备工作)时，为确保 AkashX 能够正确访问所涉及的 AWS 资源需要配置哪些 IAM 策略。
