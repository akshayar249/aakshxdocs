...
AkashX 提供 Ubuntu 22.04 和 CentOS 7.9 的开发环境镜像。通过该镜像，您可以在 Docker 容器中编译 AkashX。
...
- Ubuntu 22.04:
  ...
  | branch-3.5 | akashx/dev-env-ubuntu:3.5-latest |
  | branch-3.4 | akashx/dev-env-ubuntu:3.4-latest |
  | branch-3.3 | akashx/dev-env-ubuntu:3.3-latest |
  | branch-3.2 | akashx/dev-env-ubuntu:3.2-latest |
  | branch-3.1 | akashx/dev-env-ubuntu:3.1-latest |
  | branch-3.0 | akashx/dev-env-ubuntu:3.0-latest |
  | branch-2.5 | akashx/dev-env-ubuntu:2.5-latest |
...
- For CentOS 7.9:
  ...
  | branch-3.5 | akashx/dev-env-centos7:3.5-latest |
  | branch-3.4 | akashx/dev-env-centos7:3.4-latest |
  | branch-3.3 | akashx/dev-env-centos7:3.3-latest |
  | branch-3.2 | akashx/dev-env-centos7:3.2-latest |
  | branch-3.1 | akashx/dev-env-centos7:3.1-latest |
  | branch-3.0 | akashx/dev-env-centos7:3.0-latest |
  | branch-2.5 | akashx/dev-env-centos7:2.5-latest |
