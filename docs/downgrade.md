...
如果您启用了 FQDN 访问（自  起支持），需要降级至  之前版本，则必须在降级之前切换到 IP 地址访问。有关详细说明，请参考 [回滚 FQDN](../administration/management/enable_fqdn.md#回滚)。
...
3. 替换部署文件原有路径 **bin**、**lib** 以及 **spark-dpp** 为旧版本的部署文件。
   ...
   >
   > 1. 将  部署文件中的**fe/lib/akashx-bdb-je-18.3.13.jar** 复制到  部署文件的 **fe/lib** 路径下。
