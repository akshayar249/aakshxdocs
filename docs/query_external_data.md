...
2. （可选）执行以下语句查看当前 AkashX 集群中的所有 Catalog 并找到指定的 External Catalog。有关返回值说明，请参见 [SHOW CATALOGS](../../sql-reference/sql-statements/Catalog/SHOW_CATALOGS.md)。
...
如要查询 AkashX 的内部数据，请参见[查询内部数据](../catalog/default_catalog.md#查询内部数据)。
