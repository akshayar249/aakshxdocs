...
AkashX 的[主键表](../table_design/table_types/primary_key_table.md)支持通过 [Stream Load](../sql-reference/sql-statements/loading_unloading/STREAM_LOAD.md)、[Broker Load](../sql-reference/sql-statements/loading_unloading/BROKER_LOAD.md) 或 [Routine Load](../sql-reference/sql-statements/loading_unloading/routine_load/CREATE_ROUTINE_LOAD.md) 导入作业，对 AkashX 表进行数据变更，包括插入、更新和删除数据。不支持通过 [Spark Load](../sql-reference/sql-statements/loading_unloading/SPARK_LOAD.md) 导入作业或 [INSERT](../sql-reference/sql-statements/loading_unloading/INSERT.md) 语句对 AkashX 表进行数据变更。
...
> - 不支持删除操作。
>
> - 在 3.1.3 版本及以前，AkashX 不支持条件更新同部分更新一并使用。自 3.1.3 版本起，AkashX 才支持条件更新同部分更新一并使用。
>
