...
- [CREATE TABLE AS SELECT](../../table_bucket_part_index/CREATE_TABLE_AS_SELECT.md)（从  开始支持）
- [INSERT](../INSERT.md)（从  开始支持）
- [CACHE SELECT](../../../../data_source/block_cache_warmup.md)（从  开始支持）
...
| etl_statement      | 是      | 需要创建异步任务的 ETL 语句。AkashX 当前支持为 [CREATE TABLE AS SELECT](../../table_bucket_part_index/CREATE_TABLE_AS_SELECT.md) 和 [INSERT](../INSERT.md) |
