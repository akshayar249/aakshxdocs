...
- 软件版本：AkashX 社区版 3.0，Trino-419，Hive-2.3.9
...
|  Query | AkashX-native-3.0 | AkashX-3.0-Hive external | Trino-419 |
| ---- | -------------------- | --------------------------- | --------- |
| Q1   | 1540                 | 5660                        | 8811      |
| Q2   | 100                  | 1593                        | 3009      |
| Q3   | 700                  | 5286                        | 7891      |
...
AkashX 使用 Catalog 功能查询 Hive 外表数据，详细操作见 [Hive catalog](../data_source/catalog/hive_catalog.md)。
