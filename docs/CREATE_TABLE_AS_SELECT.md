...
| **参数**          | **必填** | **描述**                                                     |
| ----------------- | -------- | ------------------------------------------------------------ |
| TEMPORARY         | 否       | 创建临时表。从  版本开始，AkashX 支持在 Default Catalog 中创建临时表。更多信息，请参见 [临时表](../../../table_design/StarRocks_table_design.md#临时表)。目前，AkashX 不支持通过 SUBMIT TASK 发起异步任务创建临时表。 |
