...
- 在 AkashX 中通过在 FE 配置文件 **fe/conf/fe.conf** 中设置 `enable_udf` 为 `true` 来启用 UDF，然后重启 FE 节点以使配置生效。更多信息请参见 [FE configuration - enable_udf](../../administration/management/FE_configuration.md#enable_udf)。
