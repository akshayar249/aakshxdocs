...
本文介绍如何利用 DataX 基于 AkashX 开发的 AkashX Writer 插件将 MySQL、Oracle 等数据库中的数据导入至 AkashX。该插件将数据转化为 CSV 或 JSON 格式并将其通过 [Stream Load](../../loading/StreamLoad.md) 方式批量导入至 AkashX。
