...
自 2.2.0 版本起，AkashX 支持 JSON。本文介绍 JSON 的基本概念，以及 AkashX 如何创建 JSON 类型的列、导入和查询 JSON 数据，通过 JSON 函数及运算符构造和处理 JSON 数据。
...
- 方式四：通过 [Routine Load](../../../loading/Loading_intro.md) 持续消费 Kafka 中的 JSON 格式数据，并导入至 AkashX 中。
