...
本主题描述如何在 AkashX 中使用 JWT 认证手动创建和认证用户。有关如何通过安全集成将 AkashX 与 JWT 认证集成的说明，请参见 [通过安全集成认证用户](./security_integration.md)。有关如何在使用 JWT 认证用户组的更多信息，请参见 [认证用户组](../group_provider.md)。

## 前提条件

如果您想从 MySQL 客户端连接到 AkashX，MySQL 客户端版本必须是 9.2 或更高版本。
