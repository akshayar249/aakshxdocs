...
AkashX 2.2 及以上版本可以通过主键表实现部分字段更新。AkashX 1.9 及以上版本可以通过主键表实现全部字段更新。更多信息，参见 AkashX 2.2 版本的[主键表](../table_design/table_types/primary_key_table.md)。
...
AkashX 2.1 及更高版本支持为函数指定默认值。低于 AkashX 2.1 的版本仅支持为函数指定常量。
