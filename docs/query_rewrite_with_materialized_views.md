...
除了上述函数外，从 AkashX  开始，异步物化视图还支持通用聚合函数，这些函数也可用于查询改写。有关通用聚合函数的更多信息，请参见[通用聚合函数状态](../../../table_design/table_types/aggregate_table.md#generic-aggregate-states-in-asynchronous-materialized-views)。
